...
Index.filename = "/Users/208311/Development/SVELTE/svelte.technology/routes/index.html";
...
${__WEBPACK_IMPORTED_MODULE_0__components_Layout_html__["a" /* default */]._render(__result, {}, { store: options.store, slotted: { default: () => `
	<div class="hero" svelte-4008765715>
		<div class="left" svelte-4008765715>
			<h1 svelte-4008765715>Svelte</h1>
		</div>

		<div class="right" svelte-4008765715>
			<h2 svelte-4008765715>The magical disappearing UI framework</h2>

			<ul svelte-4008765715>
				<li svelte-4008765715><strong svelte-4008765715>The web's JavaScript bloat crisis, solved.</strong> Svelte turns your templates into tiny, framework-less vanilla JavaScript.</li>
				<li svelte-4008765715><strong svelte-4008765715>Simple and familiar.</strong> Build apps out of composable, easy-to-write blocks using languages you already know.</li>
				<li svelte-4008765715><strong svelte-4008765715>Super fast, rock solid.</strong> Compile-time static analysis ensures the browser does no more work than it needs to.</li>
			</ul>

			<a class="learn-svelte" href="/guide" svelte-4008765715>Learn Svelte</a>
		</div>
	</div>
` } })}`;
};
