...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Layout_html__ = __webpack_require__(183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_js__ = __webpack_require__(185);
...
Index.filename = "/Users/208311/Development/SVELTE/svelte.technology/routes/blog/[slug].html";
...
Index._render = function(__result, state, options) {
	...
	<title>${__escape(state.post.metadata.title)}</title>
`, "")}

${__WEBPACK_IMPORTED_MODULE_0__components_Layout_html__["a" /* default */]._render(__result, {page: "blog"}, { store: options.store, slotted: { default: () => `
	<article class="post" svelte-334109243>
		<h1 svelte-334109243>${__escape(state.post.metadata.title)}</h1>
		<p class="standfirst" svelte-334109243>${__escape(state.post.metadata.description)}</p>

		<p class="byline" svelte-334109243><a href="${state.post.metadata.authorURL}">${__escape(state.post.metadata.author)}</a> <time datetime="${state.post.metadata.pubdate}">${__escape(state.post.metadata.dateString)}</time></p>
...
Index.renderCss = function() {
	...
	addComponent(__WEBPACK_IMPORTED_MODULE_0__components_Layout_html__["a" /* default */]);
