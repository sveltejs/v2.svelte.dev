// Construct Uint8Array of a .zip file in store mode (i.e., no compression)

// thanks to:
// https://github.com/mrananyan/ZipperJS/blob/master/zipper.js
...
const storeZip = files => {
	...
	return Uint8Array.of(...fileData, ...centralDirectory, 0x50, 0x4B, 0x05, 0x06, 0x00, 0x00, 0x00, 0x00, ...intToBytes(files.length, 2), ...intToBytes(files.length, 2), ...intToBytes(centralDirectory.length, 4), ...intToBytes(fileData.length, 4), 0x00, 0x00);
};

export default storeZip;
